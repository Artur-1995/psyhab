...
// Работа с куки
Route::post('/accept-cookies', ['as' => 'accept.cookies', 'uses' => '\App\Http\Controllers\CookieController@store']);

Route::get('/auth', [LoginController::class, 'index'])->name('login');
// Аутентификация пользователя
Route::get('/auth-form', [LoginController::class, 'loginForm'])->name('login.form');
