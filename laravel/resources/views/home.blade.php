...
<section class="container mx-auto px-4 py-16">
    <div class="grid lg:grid-cols-2 gap-12 items-center">
        <div>
            <span class="inline-flex items-center justify-center rounded-md border px-2 py-0.5 text-xs font-medium whitespace-nowrap border-transparent bg-gray-100 text-gray-900 dark:bg-gray-800 dark:text-gray-100 mb-4">Профессиональная психологическая помощь</span>
            <h1 class="text-4xl md:text-5xl font-bold text-gray-900 mb-6">Ваше психическое здоровье — наш приоритет</h1>
            <p class="text-xl text-gray-600 mb-8">Получите профессиональную поддержку от сертифицированных психологов. Онлайн и офлайн консультации, индивидуальный подход к каждому клиенту.</p>
        ...
        <div class="relative">
            <img src="https://images.unsplash.com/photo-1754294437684-7898b3701ac7?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx0aGVyYXB5JTIwcHN5Y2hvbG9neSUyMHBlYWNlZnVzfGVufDF8fHx8MTc1Njg0MTU3OXww&ixlib=rb-4.1.0&q=80&w=1080" alt="Психологическая консультация" class="rounded-2xl shadow-2xl w-full">
        </div>
    </div>
</section>
<section class="container mx-auto px-4 py-16">
...
<section class="bg-gray-50 py-16">
    <div class="container mx-auto px-4">
        ...
        <div class="grid md:grid-cols-3 gap-8">
            <div data-slot="card" class="text-card-foreground flex flex-col gap-6 rounded-xl bg-white border-0 shadow-lg">
                <div data-slot="card-content" class="[&amp;:last-child]:pb-6 p-6">
                    <div class="w-20 h-20 bg-gradient-to-br from-blue-400 to-purple-500 rounded-full mx-auto mb-4 flex items-center justify-center"><span class="text-white text-2xl font-semibold">А</span></div>
                    ...
                    <div class="flex items-center justify-center space-x-1"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-star w-4 h-4 text-yellow-400 fill-current">
            ...
            <div data-slot="card" class="text-card-foreground flex flex-col gap-6 rounded-xl bg-white border-0 shadow-lg">
                <div data-slot="card-content" class="[&amp;:last-child]:pb-6 p-6">
                    <div class="w-20 h-20 bg-gradient-to-br from-blue-400 to-purple-500 rounded-full mx-auto mb-4 flex items-center justify-center"><span class="text-white text-2xl font-semibold">М</span></div>
            ...
            <div data-slot="card" class="text-card-foreground flex flex-col gap-6 rounded-xl bg-white border-0 shadow-lg">
                <div data-slot="card-content" class="[&amp;:last-child]:pb-6 p-6">
                    <div class="w-20 h-20 bg-gradient-to-br from-blue-400 to-purple-500 rounded-full mx-auto mb-4 flex items-center justify-center"><span class="text-white text-2xl font-semibold">Е</span></div>
