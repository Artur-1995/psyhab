...
document.getElementById('form_record').addEventListener('submit', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(event) {
    var formData, response, result, errorResponse;
...
document.addEventListener('close-modal', function () {
  alpinejs__WEBPACK_IMPORTED_MODULE_1__["default"].$data.showModal = false;
});
