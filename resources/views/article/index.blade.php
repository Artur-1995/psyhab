        ...
        <div class="container mx-auto px-4 max-w-6xl">
            ...
            <div class="grid lg:grid-cols-3 gap-8">
                <div class="lg:col-span-2 space-y-8">
                    {{-- <div class="relative">
                        <img src="{{ asset('/images/home1.png') }}" alt="Как справиться с тревожностью в современном мире"
                    ...
                    <div class="container mx-auto px-4 max-w-6xl">
                        ...
                        <div class="flex items-center justify-between mt-8">
                            <div class="flex items-center gap-4 text-sm text-gray-500">
                                <span>Автор: {{ $article->user->first_name . ' ' . $article->user->last_name }}</span>
                            ...
                            {{-- <div class="flex items-center gap-4 text-sm text-gray-500">
                                <div class="flex items-center gap-1">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                        stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-eye w-4 h-4">
                                        <path
