...
<div class="flex justify-center mb-8">
    <div class="inline-flex bg-gray-100 rounded-lg p-1"><button
            class="tariff-button inline-flex items-center justify-center whitespace-nowrap rounded-md px-6 py-3 text-sm font-medium ring-offset-white transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-600 focus-visible:ring-offset-2 active-state hover:bg-gray-50 dark:hover:bg-gray-700" data-tariff-light-type="consultation-light">Консультация</button>
            <button
            class="tariff-button inline-flex items-center justify-center whitespace-nowrap rounded-md px-6 py-3 text-sm font-medium ring-offset-white transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-600 focus-visible:ring-offset-2 hover:bg-gray-50 dark:hover:bg-gray-700" data-tariff-light-type="weekly-subscription-tariff-light">Подписка на
            неделю</button>
    </div>
</div>

<div class="max-w-3xl mx-auto px-40 mb-4">
    <div id="forms_container_tariff_light">
    </div>
</div>
